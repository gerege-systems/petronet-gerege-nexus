...
// Дүрслэлийн өмнө системийн төлөвийг асуух тул хүсэлт бүрд зурагдана.
...
export default async function PetroNetHome() {
  // Байгууллагагүй систем дээр зочин байхгүй — зөвхөн суулгасан хүн байгаа
  ...
  // шигтгэсэн зүйлийг агуулдаг бөгөөд эдгээр нь образынх биш, системийнх.
