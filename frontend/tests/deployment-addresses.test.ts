/**
 * Хоёр хаяг, хоёр алдаа, нэг шалтгаан: систем хаанаа юу байгааг хэлсэн ч
 * код нь өөр газраас асууж байв.
 *
 * Толгойн «Баримт бичиг» нь `BRAND_DOCS_URL`-ыг уншдаг байсан бол систем
...
test("the documentation menu prefers this deployment's own manual", () => {
  ...
  // Байхгүй бол систем аль хэдийн нэрлэсэн хаяг руу.
