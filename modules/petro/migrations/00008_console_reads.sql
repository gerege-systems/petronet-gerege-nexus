...
DECLARE
    t TEXT;
BEGIN
    FOREACH t IN ARRAY ARRAY['petro_stations', 'petro_station_inventory',
                             'petro_station_receipts', 'petro_dispatch_trips',
                             'petro_batches', 'petro_customs_shipments',
                             'petro_depots', 'petro_depot_tanks', 'petro_depot_receipts']
    LOOP
