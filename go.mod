module github.com/gerege-systems/petronet-gerege-nexus

go 1.26

require github.com/gerege-systems/open-gerege-nexus/backend v1.15.1-0.20260829130928-8d7e9220088f
