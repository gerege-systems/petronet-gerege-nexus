...
`API_BASE_URL` нь клиентийг өөр байрлуулалт руу заана. Энд `petronet.mn`
гэж заасан нь **төхөөрөмжийн шугамууд хараахан асаагүй** учраас: `desktop.`
ба `mobile.` хоёр DNS дээр байхгүй тул анхдагч хаягаараа явбал апп TLS
алдаагаар зогсоно. Шугамуудыг асаах дараалал —
